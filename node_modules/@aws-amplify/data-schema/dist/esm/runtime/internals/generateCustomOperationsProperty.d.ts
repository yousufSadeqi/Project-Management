...
export declare function generateCustomMutationsProperty<T extends Record<any, any>>(client: BaseClient, config: GraphQLProviderConfig['GraphQL'], getInternals: ClientInternalsGetter): import("..").CustomOperations<import("../../util").Select<T, {
    __entityType: "customMutation";
}>, "CLIENT">;
export declare function generateCustomQueriesProperty<T extends Record<any, any>>(client: BaseClient, config: GraphQLProviderConfig['GraphQL'], getInternals: ClientInternalsGetter): import("..").CustomOperations<import("../../util").Select<T, {
    __entityType: "customQuery";
}>, "CLIENT">;
export declare function generateCustomSubscriptionsProperty<T extends Record<any, any>>(client: BaseClient, config: GraphQLProviderConfig['GraphQL'], getInternals: ClientInternalsGetter): import("..").CustomOperations<import("../../util").Select<T, {
