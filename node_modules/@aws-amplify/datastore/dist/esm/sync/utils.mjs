...
import { OpType, isPredicateObj, ModelOperation, isSchemaModel, isPredicateGroup, isGraphQLScalarType, isEnumFieldType, isNonModelFieldType, isTargetNameAssociation, isSchemaModelWithAttributes } from '../types.mjs';
import { extractPrimaryKeyFieldNames, IDENTIFIER_KEY_SEPARATOR, establishRelationAndKeys } from '../util.mjs';
